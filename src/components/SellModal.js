...
export const SellModal = ({ showModal, setShowModal }) => {
  ...
  const sellShare = () => {
    ...
    volData[0].volume = Number(volData[0].volume) + Number(num);
    // let volume = 0;
        ...
        <Background onClick={closeModal} ref={modalRef}>
          <animated.div style={animation}>
            <ModalWrapper showModal={showModal}>
              ...
              <ModalContent>
                <h3>Are you ready to sell shares?</h3>
                ...
                <div className='buyText'>
                  <table>
                    ...
                    <tr>
                      <td>
                      Enter the number of share you want to sell: <input onChange={(event) => setNum(event.target.value)} type="number" placeholder='Enter the number of shares..'/>
                      </td>
                    </tr>
                  </table>
                </div>
